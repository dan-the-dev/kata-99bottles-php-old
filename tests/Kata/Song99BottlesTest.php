...
class Song99BottlesTest extends TestCase
{
    ...
    {
        $verse = $this->song99Bottles->calculateVerseFromCurrentBottleNumber(new BottleNumber(98));
    ...
    {
        $verse = $this->song99Bottles->calculateVerseFromCurrentBottleNumber(new BottleNumber(97));
